...
const ExpensiveSqlOptimazationDetail = () => {
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flex: 1, gap: '10px' }}>
              ...
              >
                {' '}
                <h6 style={{ textAlign: 'center' }}># Servers By DB Info</h6>
                <center>
                  <Gauge
                    width={200}
                    height={200}
...
export default ExpensiveSqlOptimazationDetail;
